...
import java.util.*; 
package src;
public class XifradorMonoalfabetic implements xifarar {

    // Array de majùscules
    static  final char[] majuscules = "AÀÁÄBCÇDEÈÉËFGHIÌÍÏJKLMNÑOÒÓÖPQRSTUÙÚÜVWXYZ".toCharArray();

    // Aquest array es guardarà la permutació generada per poder desxifrar després
    static final char[] permutat;
